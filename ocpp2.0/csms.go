...
func (c *chargingStationConnection) ID() string { return c.channel.GetID() }
func (c *chargingStationConnection) TLSConnectionState() *tls.ConnectionState {
...
func (cs *csms) SetNewChargingStationHandler(handler ChargingStationConnectionHandler) {
	cs.server.SetNewClientHandler(func(chargingStation ws.Channel) {
		handler(&chargingStationConnection{chargingStation})
	})
}
